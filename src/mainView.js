      ...
      <SafeAreaView>
        ...
        <Background img={require('./assets/food4.webp')} marginLeft backgroundImgHeight={'100%'} imgOpacity={0.35}>
          ...
          <View style={{flexDirection:'row',alignItems:"center"}}>
            ...
            <View style={{flexDirection: 'row',alignItems: 'center',backgroundColor: 'rgba(128,128,128,0.5)',borderRadius: 10,marginHorizontal:windowWidth*0.06,marginTop:30}}>
              <FontAwesome5 name="calendar" size={20} style={styles.icon} />
              <Field bgcolor={'rgba(128,128,128,0.1)'}  bgradius={10} placeHolder={'ದಿನಾಂಕಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ'}  phTcolor={'white'} wd={windowWidth-180} ht={58} val={textInputValue} clr={'white'} edit={false} scroll={false} ></Field>
            </View>
